...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/da.search-data.min.aeee054aba99df385e89f3813c181ebfb1d340176d7e0724506d6b523f71f3fc.js',function(){input.required=false;search();});}

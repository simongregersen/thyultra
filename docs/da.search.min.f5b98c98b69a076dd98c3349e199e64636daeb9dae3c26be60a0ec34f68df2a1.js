...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/da.search-data.min.9d7cde7cd34b1361148e172d339485aa36c46abd24b0e9e299a1a6b308ac406d.js',function(){input.required=false;search();});}

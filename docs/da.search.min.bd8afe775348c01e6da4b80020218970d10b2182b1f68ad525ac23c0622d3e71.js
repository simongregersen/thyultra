...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/da.search-data.min.242e4aa58dae1377235b4f87b1a9d9beb6f73f0444c2e40fb0e76f87ae276a83.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/da.search-data.min.25f79437f91fda9991c81a491aaceac7954113bac14a1782bf60ea7f23cac7c2.js',function(){input.required=false;search();});}
